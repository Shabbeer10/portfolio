const projectData = [
  {
    title: "SignUp4What",
    description: "This application displays data collected from user activity.",
    longdescription: "My implementation of React and it's modules. Using dummy data, the website displays user activity data in relevant chart types. Future functionality will actually be able to monitor user activity on other sites.",
    image: "https://i.postimg.cc/FsjSwMZN/signupforwhat.png",
    link: "https://signup4what.netlify.app/home",
    code: "https://github.com/shabbeer10/react.js",
  },
  {
    title: "Shop Sphere",
